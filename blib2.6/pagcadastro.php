...
<body>
    ...
    <div class="conteudo">
        <div class="conteudo2">
        <p class="p1"><a href="formularioaluno.php">Cadastrar Aluno</a></p>
        </div>
        <div class="conteudo2">
        <p class="p1"><a href="formularioarea.php">Cadastrar Área</a></p>
        </div>
        <div class="conteudo2">
        <p class="p1"><a href="formulariolivro.php">Cadastrar Livro</a></p>
        </div>
    </div>
    </section>
